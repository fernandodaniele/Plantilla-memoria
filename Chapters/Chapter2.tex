...
En segundo lugar, el módulo posee una etapa de amplificación la señal, la cual utiliza un amplificador operacional con una configuración del tipo no inversor y con una ganancia de 2, como muestra la figura \ref{fig:etapaAmpli}.
