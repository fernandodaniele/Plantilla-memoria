...
Los cambios o variaciones físicas que más se utilizan en la actualidad son:
\begin{itemize}
\item Cambio de color: es la técnica que se utiliza de manera manual en el laboratorio  de la UTN FRSFco.
\item Cambio en el potencial de un electrodo de pH: es la técnica que se utilizó para este trabajo y se detalla en la sección  \ref{tituladoresAutomaticos}.
\end{itemize}
...
Alguna subsubseccion por si la nesito
...
Ejemplo en la figura \ref{fig:texmaker}. 
...
%----------------------------------------------------------------------------------------
%Todo lo de acá para abajo es lo original por si necesito algo
