...
Por último, el ESP32 se encarga de registrar las mediciones de pH y la cantidad de volumen que dosifica la bomba. Estos valores se almacenan en una memoria micro SD y también puede ser visualizados a través de una pagina web.
